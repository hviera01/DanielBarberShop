...
class BarberoFormDialog extends ConsumerStatefulWidget {
  final BarberoModel? barbero;

  const BarberoFormDialog({super.key, this.barbero});

  @override
  ConsumerState<BarberoFormDialog> createState() => _BarberoFormDialogState();
}

class _BarberoFormDialogState extends ConsumerState<BarberoFormDialog> {
  ...
  void initState() {
    super.initState();
    final b = widget.barbero;
    if (b != null) {
      _documentoController.text = b.documento;
      _nombreController.text = b.nombreCompleto;
      _telefonoController.text = b.telefono;
      _especialidadController.text = b.especialidad;
      _comisionController.text = b.porcentajeComision == 0 ? '' : b.porcentajeComision.toString();
      _notasController.text = b.notas;
      _activo = b.estado;
    }
  }
  ...
  Future<void> _guardar() async {
    ...
    final comision = double.tryParse(_comisionController.text.trim().replaceAll(',', '.')) ?? 0;
  ...
  Widget build(BuildContext context) {
    final editando = widget.barbero != null;
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.content_cut_outlined, color: Color(0xFF0F1B3D)),
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      style: GoogleFonts.poppins(fontSize: 14),
                      decoration: _decoracion('Documento (opcional)'),
                    ),
                    const SizedBox(height: 14),
                    TextField(
                    ...
                    TextField(
                      ...
                      style: GoogleFonts.poppins(fontSize: 14),
                      decoration: _decoracion('Especialidad (opcional)'),
                    ),
                    const SizedBox(height: 14),
                    TextField(
                      ...
                      style: GoogleFonts.poppins(fontSize: 14),
                      decoration: _decoracion('% de comisión por corte'),
                    ),
                    const SizedBox(height: 14),
                    TextField(
