            ...
            Row(
              children: [
                ...
                OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFF0F1B3D), side: const BorderSide(color: Color(0xFFF3B9B9)), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
