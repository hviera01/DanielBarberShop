...
class _RegistrarVentaScreenState extends ConsumerState<RegistrarVentaScreen> {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(formatearMoneda(carrito.totalConRecargo), style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w800, color: Colors.white)),
                      ],
                    ),
                  ),
  ...
  Widget _campoInlineNumero(String claveFoco, TextEditingController controlador, double valorActual, void Function(double) alConfirmar, {String? sufijo, String? prefijo, bool dosDecimales = false}) {
    ...
    // dejar escribir directo ahí, o en el celular a abrir su teclado un
    // instante). El GestureDetector de afuera es quien recibe el toque;
    // AbsorbPointer evita que ese mismo toque le llegue al TextField, así
    // que nunca se enfoca ni parpadea el cursor, sea con mouse o con el
    // dedo. El foco por teclado físico (Tab) no pasa por gestos de puntero,
    // así que seguir tipeando y dándole Enter sin abrir el diálogo sigue
